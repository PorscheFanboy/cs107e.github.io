...
The comments in `codegen.c` guide you through four concepts: (a) if/else,
(b) loops (c) comparing pointer/array accesses, (d) pointer/bitwise expressions to set GPIO registers, and (e) if/else versus switch.

During lab time, we'd like you and your partner to work through the first four parts (a) -(d), and (e) if possible.
Use the comments in the C source as your guide. If time is running short, leave part(e) for later completion on your own.
