...
void test_gpio_set_get_function() {
  ...
  assert( gpio_get_function(GPIO_PIN2) == GPIO_FUNC_OUTPUT );
  assert( gpio_get_function(GPIO_PIN4) == GPIO_FUNC_INPUT );

  gpio_set_function(GPIO_PIN10, GPIO_FUNC_OUTPUT);
  assert( gpio_get_function(GPIO_PIN10) == GPIO_FUNC_OUTPUT );
  gpio_set_function(GPIO_PIN11, GPIO_FUNC_OUTPUT);
  assert( gpio_get_function(GPIO_PIN10) == GPIO_FUNC_OUTPUT );
  assert( gpio_get_function(GPIO_PIN11) == GPIO_FUNC_INPUT );
  assert( gpio_get_function(GPIO_PIN12) == GPIO_FUNC_INPUT );
