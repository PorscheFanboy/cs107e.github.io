...
void main(void) {
  ...
  // get_pitch returns the number of bytes, while cbars expects the number
  // of pixels. Since pixels are 4 bytes, divide by 4.
  cbars((unsigned *)fb_get_front_buffer(), fb_get_pitch() / 4, fb_get_height());
