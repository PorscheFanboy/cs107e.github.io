...
To draw a character, you need some notion of a font. Our provided `font.c` can help with this! It supplies character images used to draw text on the screen.
