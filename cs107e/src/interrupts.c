...
// (supposed to be done in cstart.c) before attempting to attach
// handlers
...
// All of the other vectors are empty functions and
// declared as weak symbols in libpi. Because they are weak,
// a strong symbol defined by client will take precedence.
// This allows the client to supply their own version of the
// vector if desired.
